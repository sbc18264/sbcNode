...
namespace panda {
	...
	*/
	...
	const char *General::panda_VERSION = "1.2.0";
	...
	const char *General::CONFIG_FILE = "config/panda.json";
	const char *General::MONITOR_CONFIG_FILE = "config/monitor.json";
	const char *General::LOGGER_FILE = "log/panda.log";
	...
	const char *General::CONTRACT_VALIDATOR_ADDRESS = "XMbrLjgR1Q4wqhFbAMqYa8hQPjL5hyMmx9HBa";
	const char *General::CONTRACT_FEE_ADDRESS = "XMbrLjgR1Q4wqhFbAMqYa8hQPjL5hyMmx9HBa";
